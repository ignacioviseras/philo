...
/*   Updated: 2025/03/04 18:58:56 by igvisera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_dinner(t_data *data)
{
	...
	if (data->max_eats == 0)
		...
		handle_thread(&data->philos[0].thread_id, one_philo, &data->philos[0],
			CREATE);
	else
	{
		while (i < data->n_philo)
		{
			handle_thread(&data->philos[i].thread_id, dinner_simulat,
